            ...
            <div class="content">
                <form method="POST">
                    ...
                    <datalist id="soort" name="soort">
                        <!-- eventueel dinamisch -->
                        <option value="Ijs">
                        <option value="Koude Hapjes">
                        <option value="Mousse">
                        <option value="Koude voorgerechten">
                        <option value="Vegetarisch hoofdgerechten">
                        <option value="Visgerechten">
                    </datalist>
                    <br>
                    ...
                    <a href="index.php?page=GerechtEten">Terug naar overzicht</a>
                </form>
            </div>
    <?php
        }
...
if (isset($_POST['bewerken'])) {
    ...
    if ($updateSoort) {
        echo "<script>alert('Gegevens is geupdate');
                        location.href='index.php?page=GerechtEten';</script>";
    } else {
